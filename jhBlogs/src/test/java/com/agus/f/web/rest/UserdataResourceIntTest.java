...
import static com.agus.f.web.rest.TestUtil.createFormattingConversionService;
...
public class UserdataResourceIntTest {
    ...
    public void getUserdata() throws Exception {
        ...
        // Get the userdata
        restUserdataMockMvc.perform(get("/api/userdata/{id}", userdata.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
    ...
    public void deleteUserdata() throws Exception {
        ...
        // Get the userdata
        restUserdataMockMvc.perform(delete("/api/userdata/{id}", userdata.getId())
