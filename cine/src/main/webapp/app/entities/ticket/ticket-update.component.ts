...
export class TicketUpdateComponent implements OnInit {
    ...
    save() {
        this.isSaving = true;
        this.ticket.fechaTransaccion = moment(this.fechaTransaccion, DATE_TIME_FORMAT);
    ...
    set ticket(ticket: ITicket) {
        this._ticket = ticket;
        this.fechaTransaccion = moment(ticket.fechaTransaccion).format(DATE_TIME_FORMAT);
