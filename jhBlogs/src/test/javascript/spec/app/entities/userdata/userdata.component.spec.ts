...
import { UserdataComponent } from 'app/entities/userdata/userdata.component';
...
describe('Component Tests', () => {
    describe('Userdata Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.userdata[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
