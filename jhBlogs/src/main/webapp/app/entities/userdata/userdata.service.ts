...
type EntityResponseType = HttpResponse<IUserdata>;
type EntityArrayResponseType = HttpResponse<IUserdata[]>;

@Injectable({ providedIn: 'root' })
export class UserdataService {
    private resourceUrl = SERVER_API_URL + 'api/userdata';
    ...
    update(userdata: IUserdata): Observable<EntityResponseType> {
        return this.http.put<IUserdata>(this.resourceUrl, userdata, { observe: 'response' });
    }
