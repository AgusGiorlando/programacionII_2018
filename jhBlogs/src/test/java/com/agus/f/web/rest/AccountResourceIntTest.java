...
import com.agus.f.JhBlogsApp;
import com.agus.f.config.Constants;
import com.agus.f.domain.Authority;
import com.agus.f.domain.User;
import com.agus.f.repository.AuthorityRepository;
import com.agus.f.repository.UserRepository;
import com.agus.f.security.AuthoritiesConstants;
import com.agus.f.service.MailService;
import com.agus.f.service.UserService;
import com.agus.f.service.dto.PasswordChangeDTO;
import com.agus.f.service.dto.UserDTO;
import com.agus.f.web.rest.errors.ExceptionTranslator;
import com.agus.f.web.rest.vm.KeyAndPasswordVM;
import com.agus.f.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = JhBlogsApp.class)
