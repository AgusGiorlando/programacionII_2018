...
import static ar.edu.um.prog2.web.rest.TestUtil.sameInstant;
import static ar.edu.um.prog2.web.rest.TestUtil.createFormattingConversionService;
...
public class TicketResourceIntTest {
    ...
    public void getAllTickets() throws Exception {
        ...
        restTicketMockMvc.perform(get("/api/tickets?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].fechaTransaccion").value(hasItem(sameInstant(DEFAULT_FECHA_TRANSACCION))))
    ...
    public void getTicket() throws Exception {
        ...
        restTicketMockMvc.perform(get("/api/tickets/{id}", ticket.getId()))
            ...
            .andExpect(jsonPath("$.fechaTransaccion").value(sameInstant(DEFAULT_FECHA_TRANSACCION)))
