    ...
    describe('Userdata Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/userdata';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Userdata', () => {
                service.create(new Userdata(null)).subscribe(received => {
            ...
            it('should update a Userdata', () => {
                service.update(new Userdata(123)).subscribe(received => {
